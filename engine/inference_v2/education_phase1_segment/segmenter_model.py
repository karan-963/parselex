"""Phrase segmenter architecture for education phase-1 token segmentation.

Mirrors ``training_pipeline/education/new_phase1_token_segmentation/src/model.py``.
"""
...
class SpatialBoundaryGate(nn.Module):
    def __init__(self, spatial_in_dim: int = 12, num_labels: int = 3, hidden_size: int = 768) -> None:
        ...
        self.spatial_conv = nn.Conv1d(
            in_channels=spatial_in_dim, out_channels=128, kernel_size=5, padding=2,
        )
