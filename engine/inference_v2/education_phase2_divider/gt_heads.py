"""Map MongoDB educationEntryHeads to inference token line indices via y0."""
...
def resolve_education_gt_heads(resume_id: str, edu_tokens: list[dict]) -> set[tuple[int, int]]:
    ...
    if not mongo_heads or not edu_tokens:
        return set()
